var CustomValidationCNPJ = {};
CustomValidationCNPJ.Init = function () {
    //CustomValidationCNPJ
    $.validator.addMethod('customvalidationcnpj', function (value, element, params) {
        var cnpj = value.replace(/[^0-9]/gi, ''); //Remove tudo que não for número
    ...
    $.validator.unobtrusive.adapters.add('customvalidationcnpj', {}, function (options) {
